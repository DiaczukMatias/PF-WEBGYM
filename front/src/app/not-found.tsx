    ...
    return (
        ...
        <div className="bg-secondary2 w-full px-16 md:px-0 h-screen flex items-center justify-center">
            <div className="bg-primary border-4 border-accent2 flex flex-col items-center justify-center px-4 md:px-8 lg:px-24 py-8 rounded-lg shadow-2xl">
                ...
                <p className="text-2xl md:text-3xl lg:text-5xl font-bold tracking-wider text-accent">Página no encontrada</p>
                <p className="text-secondary mt-4 pb-4 border-b-2 text-center">Lo sentimos, no pudimos encontrar la página que buscas. </p>
                <p className="text-secondary mt-4 pb-4 border-b-2 text-center">Es posible que esté en construcción o que la URL sea incorrecta. Por favor, verifica la dirección o regresa al inicio. </p>
