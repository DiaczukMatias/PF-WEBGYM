...
{/* Verifica si estás en la ruta /admin *//*}
{window.location.pathname.includes("/admin") ? (
  <div className="text-center">
    <Image
      ...
      className="w-auto rounded-lg object-contain sm:min-h-24 sm:max-h-48 md:min-h-28 md:max-h-64 lg:min-h-36 lg:max-h-72 border border-accent"
    />
    <h1 className="bottom-0 ml-4 text-center sm:text-lg md:text-xl lg:text-2xl font-semibold mb-4 flex flex-wrap text-white text-shadow-lg fontOswaldSans-serif">
      {categoria.nombre.toUpperCase()}
    </h1>
